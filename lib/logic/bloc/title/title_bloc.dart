...
class TitleBloc extends Bloc<TitleEvent, TitleState> {
  TitleBloc() : super(TitleInitial()) {
    ...
    on<PaginationBooks>(_pagination);
  }
  final TitleRepository _titleRepository = TitleRepository();
  ...
  Future<void> _pagination(
      PaginationBooks event, Emitter<TitleState> emit) async {
