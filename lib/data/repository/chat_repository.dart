...
class ChatRepository {
  ...
  Future<ChatListModel> getChatMessages(String user_id,String book_id, String page) async {
    final response = await _apiProvider
        .get('/chat_messages_api.php?user_id=${user_id}&page=${page}&book_id=${book_id}');
